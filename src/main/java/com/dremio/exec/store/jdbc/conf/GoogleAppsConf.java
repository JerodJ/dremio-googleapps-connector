...
@SourceType(value = "GoogleAppsARP", label = "GoogleApps",uiConfig = "googleapps-layout.json")
public class GoogleAppsConf extends AbstractArpConf<GoogleAppsConf> {
  private static final String ARP_FILENAME = "arp/implementation/googleapps-arp.yaml";
  private static final ArpDialect ARP_DIALECT =
      AbstractArpConf.loadArpFile(ARP_FILENAME, (ArpDialect::new));
  private static final String DRIVER = "cdata.jdbc.googleapps.GoogleAppsDriver";
